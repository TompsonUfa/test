        ...
        <div class="content">
            <div class="container-fluid d-flex justify-content-center align-items-center flex-column">
                <div class="row p-5 mb-3 block-wrapper">
                    ...
                    <div class="col-12">
                        <input type="text" class="form-control mb-3" name="nameTest" placeholder="Название теста"
                            require />
                        <input type="text" class="form-control mb-3" name="descTest" placeholder="Описание теста"
                            require />
                        <input type="text" class="form-control mb-3" name="descTest" placeholder="Категория теста"
                            require />
                    </div>
                </div>
                <div class="row p-5 mb-3 block-wrapper question" data-list-number="1">
                    ...
                    <div class="col-12 list-options">
                        <div class="list-options__item mb-3 d-flex justify-content-center align-items-center">
                            <input class="form-check-input mx-2" type="radio" name="options-1" checked />
                            <input type="text" class="form-control" placeholder="Вариант" require />
                        </div>
                    </div>
                    <div class="col-12">
